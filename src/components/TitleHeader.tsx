        ...
        <>
            <div className='flex mb-3 border border-slate-400 py-5 px-4 rounded  bg-slate-300'>
                ...
                <div className='flex-1 flex justify-end'>
                    <button type="submit" className="text-white bg-slate-800 hover:bg-slate-700 focus:ring-4 hover:shadow-md hover:bg-opacity-90   font-medium rounded-lg text-sm px-4 py-1.5 text-center">
                        +
                    </button>
                </div>
            </div>
