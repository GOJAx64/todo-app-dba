      ...
      <div className="flex items-center justify-center min-h-screen bg-slate-300">
          ...
          <div className=" flex flex-col m-6 space-y-10 bg-slate-200 shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0">
              ...
              <div className="p-6 md:px-8 md:py-8">      
                  ...
                  <input type="text" className="block w-full py-4 px-3 mb-2 border bg-slate-100 border-gray-300 rounded-md placeholder:font-sans placeholder:font-light" placeholder="Ingresa tu nombre"/>
                  <label className='text-gray-600'>Usuario</label>
                  <input type="text" className="block w-full py-4 px-3 mb-2 border bg-slate-100 border-gray-300 rounded-md placeholder:font-sans placeholder:font-light" placeholder="Ingresa tu nombre de usuario"/>
                  <label className='text-gray-600'>Correo electrónico</label>
                  <input type="text" className="block w-full py-4 px-3 mb-2 border bg-slate-100 border-gray-300 rounded-md placeholder:font-sans placeholder:font-light" placeholder="Ingresa tu correo eléctronico"/>
                  <label className='text-gray-600'>Contraseña</label>
                  <input type="password" className="block w-full mb-2 py-4 px-3 border bg-slate-100 border-gray-300 rounded-md placeholder:font-sans placeholder:font-light" placeholder="Ingresa tu contraseña"/>
